    ...
    <div className="small-container section">
      ...
      <ul>
        <li>
          ...
          professionals and technicians who are dedicated to delivering top-notch aesthetic and
          wellness services.
        </li>
        <li>
          <strong>Cutting-Edge Technology:</strong> We understand that every individual has unique
          needs and goals. We take the time to listen to your concerns and tailor our treatments to
          your specific requirements.
        </li>
        <li>
          <strong>Safety First:</strong> Your safety and well-being are our top priorities. Rest
          assured that all our procedures are conducted with the highest standards of safety and
          hygiene.
        </li>
        <li>
